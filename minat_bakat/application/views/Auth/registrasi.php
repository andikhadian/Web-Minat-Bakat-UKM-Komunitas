...
<body>
                ...
                <div class="row">
                    <div class="col-12">
                                        ...
                                        <form method="POST" action="">
                                            <div class=" row">
                                                <div class="form-group col-12">
                                                    ...
                                                    <input id="nama_user" type="text" class="form-control" name="nama_user" value="<?= set_value('nama_user'); ?>" />
                        ...
                        <div class="simple-footer">
                            Copyright &copy;
                            <a href="http://instagram.com/nurasiahayoto" class="text-primary">Nur Asia Hayoto</a>
                            2020
                        </div>
                    </div>
                </div>
    ...
    <script src="<?= base_url() ?>asset_admin/js/page/auth-register.js"></script>
</body>
